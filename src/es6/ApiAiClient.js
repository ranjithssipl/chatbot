...
import { SetContexts } from "./Request/SetContexts";
...
export class ApiAiClient {
    ...
    setContexts( contexts, intent, options = {}) {
        if (!contexts) {
            throw new ApiAiClientConfigurationError("Contexts can not be empty");
        }
        options.contexts = contexts
        options.query = intent
        return new SetContexts(this, options).perform();
    }
