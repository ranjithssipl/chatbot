...
import { Widget, addUserMessage, addResponseMessage, renderCustomComponent, toggleWidget, toggleInputDisabled, addLinkSnippet, dropMessages } from 'react-chat-widget';
...
class App extends Component {
        ...
        if (!valid_message) {
            this.apiAiClient.textRequest(newMessage).then((response) => {
                ...
                if(newMessage != "welcome")
                    this.storeContexts(context_object.reverse(), intent_name, user);
                ...
                var res = response.result.fulfillment.speech.replace(/Hari|Hari?|Jerome|Jerome?|Faisal|Faisal?/gi, user);
                var speech = res;
                ...
                if (speech.includes(".mp4")) {
                                ...
                                <div className="ratingsubdiv">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div id="button_div" className="col-md-7">
                                            <button type="button" className="btn btn-primary" value="Done" onClick={this.closeWidget}>Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <form className="well form-horizontal" id="upload_form">
                                    <div className="form-group">
                                        ...
                                        <div className="fileupload fileupload-new" data-provides="fileupload" >
                                            <span className="btn btn-primary btn-file">
                                                <span className="fileupload-new" >Attach</span>
                                                <span className="fileupload-exists">Attach</span>
                                    ...
                                    <div className="transaction_summary_button_design">
                                        <button type="button" className="btn btn-primary" value="Upload" onClick={this.uploads}>Upload</button>
                    ...
                    // Use Case 3
                        ...
                        for (let index in split_text) {
                            ...
                            else addResponseMessage(split_text[index])
                        }
                        ...
                        suggestionView = ({ color, handleClick }) =>
                            <div>
                                ...
                                <div className="button_text_list">
                                    <ul>
                                        <li><a target="_self" href="javascript:void(0)" onClick={this.handleClick.bind(this, "Enroll Now")}>Enroll Now</a></li>
                                        <li><a target="_self" href="javascript:void(0)" onClick={this.handleClick.bind(this, "Terms & Conditions")}>Terms & Conditions</a></li>
                                        <li><a target="_self" href="javascript:void(0)" onClick={this.handleClick.bind(this, "Not Interested")}>Not Interested</a></li>
                                    </ul>
                                </div>
                            </div>
                        renderCustomComponent(suggestionView)
                    ...
                    // remittance project...
                        ...
                        suggestionView = ({ color, handleClick }) =>
                            <div>
                                <div className="container_div">
                                    ...
                                    <div className="table-responsive">
                                        <table className="table transaction_summary_table_design">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Address</td>
                                                    <td>1st Floor, Deira, P.O.Box 777</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div className="transaction_summary_button_design">
                                        <button type="button" className="btn btn-primary" onClick={this.handleClick.bind(this, "Confirm")}>Confirm</button>
                        ...
                        var conf = {
                            ...
                            suggestionView = ({ color, handleClick }) =>
                                // var Highcharts = 'Highcharts';
                                <ChartView style={{ height: 350, marginBottom: 20 }} config={conf} onMessage={this.onMessage} ></ChartView>
                        renderCustomComponent(suggestionView)
                        ...
                        suggestionView = ({ color, handleClick }) =>
                            <div>
                                <form className="well form-horizontal" action="#" target="_self" id={id}>
                                    <div className="radio">
                                        <label><input type="radio" id="radio" name="amount" />Usual amount(INR2,00,000)</label>
                                    </div>
                                    <div className="radio">
                                        <label><input type="radio" id="radio" name="amount" /><input type="text" className="form-control" placeholder="another amount type in INR" /></label>
                                    </div>
                        ...
                        suggestionView = ({ color, handleClick }) =>
                            <div className="button_text_list">
                                <ul>
                                    <li><a target="_self" href="javascript:void(0)" onClick={this.handleNewUserMessage.bind(this, intent)}>Yes</a></li>
    ...
    apparel_400(id_no) {
        var id = "tableModal" + "_" + id_no;
        suggestionView = ({ color, handleClick }) =>
            <div id={id} className="tableModal">
                <div className="tableModal-content">
                    <button type="buton" className='tableClose-modal' onClick={this.closeTable}>
                        <span className="tableClose">&times;</span>
                    </button>
                    <div className="tableModal_body">
                        <div className="container_div">
    ...
    target_400(id_no) {
        suggestionView = ({ color, handleClick }) =>
            <div id="tableModal" className="tableModal">
                <div className="tableModal-content">
                    <button type="buton" className='tableClose-modal' onClick={this.closeTable}>
                        <span className="tableClose">&times;</span>
                    </button>
            ...
            >
                ...
                <div className="tableModal-content">
                    ...
                    <div className="customModal_body">
                        <p>Every purchase now earns you skyward miles.
                            With the Emirates World credit card you earn miles on every transaction.
              Enjoy golf privileges, complimentary airport lounge access, shopping perks and more.</p>
                    </div>
                </div>
            </Modal>
        // <div id="myModal" className="customModal">
        //     <div className="customModal-content">
        //         <button type="buton" className='customClose-modal' onClick={this.closeModal}>
    ...
    getContexts() {
        ...
        axios.get(url)
            .then(response => {
                ...
                if (response.data.contexts != undefined) {
